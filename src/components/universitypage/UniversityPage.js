        ...
        <div className="university-main">
            ...
            <div className="university-info">
                <div className="university-info__text-block">
                    ...
                    <p className="university-info__text"><i className="material-icons info-icon">place</i>ул. Ленинские Горы, 1с73, Москва, 119234</p>
                    ...
                    <a className="university-info__link" target="_blank" rel="noopener norefferer" href="https://www.msu.ru/"><i className="material-icons info-icon">language</i>msu.ru</a>
